...
int main(int argc, char *argv[])
{
    ...
    if (pcl::io::loadPCDFile<pcl::PointXYZ>("/home/lu/Download/pcl_tools/src/data/finalcloud.pcd", *cloud) == -1)
    {
    ...
    ofstream zos("/home/lu/Download/pcl_tools/src/data/testfinal.txt");
    for (int i = 0; i<Num; i++)
    {
